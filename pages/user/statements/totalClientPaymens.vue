...
$startLoading()
const { data, refresh } = await useFetch('/api/get-totals-abilling', {
  query: {
...
<template>
  <div py-4 px-0>
    <div class="inline-flex">
      ...
      <div btn rounded-0 hover:bg-indigo-500 bg-indigo-700 dark:bg-blue-500 h-8 text-center px-2 flex items-center
