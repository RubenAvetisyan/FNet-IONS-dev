SELECT vgroups.vg_id, vgroups.login, vgroups.agrm_id, vgroups_addr.address, groups.name as gr_name, vgroups.blocked as 'status', vgroups.block_date, 
...
temp4.above as addit_serv_price, temp3.timefrom as addit_serv_timefrom, vgroups.acc_ondate, ifnull(vgroups_addons_vals.str_value,'') as IP
...
left join vgroups_addons_vals on vgroups.vg_id=vgroups_addons_vals.vg_id and vgroups_addons_vals.name='public_ip'
