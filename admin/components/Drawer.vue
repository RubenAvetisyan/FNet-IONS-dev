      ...
      <ul class="space-y-0">
        <li>
          <div ref="listBtn"
            ...
            <div v-show="isVisible" class="flex-1 ml-3 text-left whitespace-nowrap">Payment System</div>
            <div class="i-mdi-chevron-down" />
          </div>
          <ul id="sub" ref="sub" class="hidden  space-y-0">
            <list-tiem v-for="item in ['Products', 'Billing', 'Invoice']" :is-menuitem="true"
