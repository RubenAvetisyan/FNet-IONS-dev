  ...
  <div class="w-full h-screen">
    <div class="w-full bg-white border rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
      <div class="sm:hidden">
        ...
        <ul id="fullWidthTab" hidden text="sm center gray-500 dark:gray-400" font="medium" divide="x gray-200 dark:gray-600"
        ...
        <div id="fullWidthTabContent" border="t gray-200 dark:gray-600">
          <div id="stats" p="4 md:8" bg="white dark:gray-800" rounded="lg" role="tabpanel" aria-labelledby="stats-tab">
            <dl display="grid" grid="cols-2 sm:cols-3 xl:cols-6" gap="8 sm:8" max="w-screen-xl" p="4" mx="auto"
