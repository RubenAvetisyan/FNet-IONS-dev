<template>
  <div class="w-full h-screen">
    <div class="w-full bg-white border rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      <ul
        id="fullWidthTab" hidden text="sm center gray-500 dark:gray-400" font="medium" divide="x gray-200 dark:gray-600"
        sm="flex" rounded="lg" bg="gray-50 hover:gray-100 dark:gray-700 dark:hover:gray-600" focus="outline-none"
      ...
      >
        <li class="w-full">
          <button
            ...
            inline="block" w="full" p="4" rounded="tl-lg" bg="gray-50 hover:gray-100 dark:gray-700 dark:hover:gray-600"
            focus="outline-none"
          >
            Statistics
          </button>
        ...
        <li class="w-full">
          <button
            ...
            aria-selected="false" inline="block" w="full" p="4" bg="gray-50 hover:gray-100 dark:gray-700 dark:hover:gray-600"
            focus="outline-none"
          >
            Services
          </button>
        ...
        <li class="w-full">
          <button
            ...
            inline="block" w="full" p="4" rounded="lg" bg="gray-50 hover:gray-100 dark:gray-700 dark:hover:gray-600"
            focus="outline-none"
          >
            FAQ
          </button>
      ...
      <div id="fullWidthTabContent" border="t gray-200 dark:gray-600">
        <div id="stats" p="4 md:8" bg="white dark:gray-800" rounded="lg" role="tabpanel" aria-labelledby="stats-tab">
          <dl
            display="grid" grid="cols-2 sm:cols-3 xl:cols-6" gap="8 sm:8" max="w-screen-xl" p="4" mx="auto"
            text="gray-900 dark:white"
          >
            <div display="flex" flex="col" items="center" justify="center">
              <dt class="mb-2 text-3xl font-extrabold">
                73M+
              </dt>
              <dd font="light" text="gray-500 dark:gray-400">
                Developers
              </dd>
            </div>
            <div display="flex" flex="col" items="center" justify="center">
            ...
            <div display="flex" flex="col" items="center" justify="center">
              ...
              <dd display="flex" flex="col" font="light" text="gray-500 dark:gray-400">
        ...
        <div id="about" p="4 md:8" bg="white dark:gray-800" rounded="lg" role="tabpanel" aria-labelledby="about-tab">
          ...
          <ul role="list" class="space-y-4 text-gray-500 dark:text-gray-400">
            <li class="flex space-x-2">
              <!-- Icon -->
              <svg
                class="flex-shrink-0 w-4 h-4 text-blue-600 dark:text-blue-500" fill="currentColor" viewBox="0 0 20 20"
        ...
        <div id="faq" p="4 md:8" bg="white dark:gray-800" rounded="lg" role="tabpanel" aria-labelledby="faq-tab">
          <div
          ...
          >
            ...
            <h2 id="accordion-flush-heading-2">
              ...
              >
                ...
                <svg
                  data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    fill-rule="evenodd"
            ...
            <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
              <div class="py-5 font-light border-b border-gray-200 dark:border-gray-700">
                ...
                <ul class="pl-5 text-gray-500 list-disc dark:text-gray-400">
                  ...
                  <li>
                    <a
                      href="https://tailwindui.com/" rel="nofollow"
                      class="text-blue-600 dark:text-blue-500 hover:underline"
                    >Tailwind UI</a>
                  </li>
                </ul>
