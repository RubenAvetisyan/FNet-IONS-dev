<template>
  <div class="w-full h-screen">
    <div class="w-full bg-white border rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      <ul
        id="fullWidthTab"
        class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400" data-tabs-toggle="#fullWidthTabContent" role="tablist"
      >
        <li class="w-full">
          <button
      ...
      <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
        <div
          id="stats" class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" role="tabpanel"
        ...
        <div
          id="about" class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" role="tabpanel"
        ...
        >
          ...
          <ul role="list" class="space-y-4 text-gray-500 dark:text-gray-400">
            <li class="flex space-x-2">
              <!-- Icon -->
              <svg
                class="flex-shrink-0 w-4 h-4 text-blue-600 dark:text-blue-500" fill="currentColor"
        ...
        <div
          id="faq" class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" role="tabpanel"
          ...
          >
            <h2 id="accordion-flush-heading-1">
              ...
              >
                ...
                <svg
                  data-accordion-icon class="w-6 h-6 rotate-180 shrink-0" fill="currentColor"
                  viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    fill-rule="evenodd"
            ...
            <h2 id="accordion-flush-heading-2">
              ...
              >
                ...
                <svg
                  data-accordion-icon class="w-6 h-6 shrink-0" fill="currentColor"
                  viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    fill-rule="evenodd"
